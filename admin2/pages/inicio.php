 <?php echo '<script type="text/x-handlebars" id="index">' ?>
               
                <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Escritorio</h2>   
                        <h5>Bienvenido <?php echo $_SESSION['carlos'] ?>  </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">36 Obras</p>
                    <p class="text-muted">Dar Seguimiento</p>
                </div>
             </div>
		     </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">30 Noticias</p>
                    <p class="text-muted">Publicar Nueva</p>
                </div>
             </div>
		     </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">En estudio</p>
                    <p class="text-muted">Lista de Proyectos</p>
                </div>
             </div>
		     </div>
			</div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                               Personas que usan nuestra aplicación
                               
                                <?php
                                
                                $a = $db->getUsersRealTime();
