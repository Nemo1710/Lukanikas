...
public class ejem3web extends Activity {
	private static final String TAG = "bluetooth2";
	  ...
	  public void onCreate(Bundle savedInstanceState) {
		...
		//Toast.makeText(getApplicationContext(),"esto es"+ val, Toast.LENGTH_SHORT).show();
		CallAPI tarea = new CallAPI();
        tarea.execute(val);
        mijo=new TextSpeaker(getApplicationContext());
	  ...
	  private class CallAPI extends AsyncTask<String, String, String> {
		    ...
		    protected String  doInBackground(String... params) {
		        ...
		        try {
		    		...
		    		mensaje=mijin1.secuencia(params[0]);
		    		//
